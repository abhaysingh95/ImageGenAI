  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20' initial={{opacity:0.2, y:100}} transition={{duration:1}} whileInView={{opacity:1, y:0}} viewport={{once:true}}>
        ...
        transition={{delay:0.6, duration:0.8}}>
            Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type, and wath the magic happen.
        </motion.p>

        <motion.button onClick={onclickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-10 py-2.5 flex items-center gap-2 rounded-full'
        ...
        transition={{default: {duration: 0.5}, opacity: {delay: 0.8, duration: 1}}}>
            Generate Images
            <img className='h-6' src={assets.star_group} alt='arrow' />
        </motion.button>
        ...
        initial={{opacity:0}}
        animate={{opacity:1}}
        trnasiton={{delay:1.2, duration:0.8}}
