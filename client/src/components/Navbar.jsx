...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4'>
        <Link to='/'>
        <img src={assets.mylogo} alt="Logo" className="w-28 sm:w-32 lg:w-40" />
        </Link>
        ...
        <div>
            ...
            <div className='flex text-center gap-2 sm:gap-3'>
              ...
              <p className='text-gray-600 max-sm:hidden pl-4 mt-2'>Hi, {user.name}</p>
              <div className='relative group'>
                <img src={assets.profile_icon} alt="Avatar" className='w-10 drop-shadow' />
